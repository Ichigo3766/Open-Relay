...
final sidebar background-color adjustment, using Release builds, Xcode 27, one
iPhone 16 Pro simulator running iOS 27, and the same invented completed chat.
