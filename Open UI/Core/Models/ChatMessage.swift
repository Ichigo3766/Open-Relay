...
nonisolated struct MessageAnnotation: Codable, Hashable, Sendable {
...
nonisolated struct ChatSourceReference: Codable, Identifiable, Hashable, Sendable {
    var id: String?
    var title: String?
    var url: String?
    var snippet: String?
...
nonisolated struct ChatStatusItem: Codable, Sendable {
    var title: String?
    var link: String?
}

/// A status update during message streaming (e.g., tool calls, web searches).
nonisolated struct ChatStatusUpdate: Codable, Sendable {
    var action: String?
    var status: String?
...
nonisolated struct ChatMessageFile: Codable, Hashable, Sendable {
...
nonisolated struct AnyCodableMap: Codable {
...
nonisolated struct ChatMessageVersion: Codable, Equatable, Hashable, Sendable {
    enum CodingKeys: String, CodingKey {
